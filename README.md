...
- `moticon-web`: GitHub `main`과 연결되는 React/Vite Cloudflare Pages 프런트엔드
- `moticon-api`: Workers AI, D1, R2를 사용하는 API Worker로 이전 예정
...
- Cloudflare Pages 자동 배포를 위한 SPA 라우팅과 `VITE_API_BASE_URL` 기반 프런트/API 분리 구조 추가
